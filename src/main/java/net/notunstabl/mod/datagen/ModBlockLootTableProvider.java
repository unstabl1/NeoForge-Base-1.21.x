...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.EXAMPLE_ORE.get(),
                block -> createOreDrop(ModBlocks.EXAMPLE_ORE.get(), ModItems.EXAMPLE_ITEM_1.get()));

//      The way to make ores drop multiple items
//        this.add(ModBlocks.EXAMPLE_ORE.get(),
//                block -> createMultipleOreDrops(ModBlocks.EXAMPLE_ORE.get(), ModItems.EXAMPLE_ITEM_1.get(), 2, 5));
